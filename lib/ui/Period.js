...
const h = require('react-hyperscript')
    , R = require('ramda')
    , { Box } = require('axs-ui')
    , { originalLabel, alternateLabels } = require('../util/period')
...
function Period({ linkify }) {
  return (
    h('dl', [
      OriginalLabel({ label: originalLabel(period) }),

      AlternateLabels({ labels: alternateLabels(period) }),
